...
backend_args = None
data_prefix = dict(pts='', cam0='', cam2='', cam4='', cam6='', cam8='')
...
train_pipeline = [
    dict(
        type='LoadPointsFromFileJRDB',
        coord_type='LIDAR',
        load_dim=4,
        use_dim=4
    ),
    dict(
        type='LoadMultiViewImageFromFilesJRDB',
        to_float32=True,
        color_type='color',
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='JRDB_infos_train_small.pkl',
